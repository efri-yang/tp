...
<!-- side  end****************************************************** -->
    ...
    <div class="am-form am-form-horizontal mt20 pr30">
        <form action="<?php echo url('add'); ?>" method="post" data-am-validator>
            <div class="am-form-group">
                ...
                <div class="am-para-input lh-default">
                	<?php if(is_array($groupList) || $groupList instanceof \think\Collection || $groupList instanceof \think\Paginator): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	                	<label class="pr15"><input type="checkbox" name="group_id[]" value="<?php echo $vo['id']; ?>" required><?php echo $vo['title']; ?></label>
            ...
            <div class="am-form-group">
                <label class="am-para-label">密码确认：</label>
                <div class="am-para-input">
                	<input type="password"  value="<?php echo (\think\Session::get('form_info.password') ?: ''); ?>" required  minlength="6" data-equal-to="#J_password" placeholder="输入密码(至少6个字符)" />
                </div>
            </div>
